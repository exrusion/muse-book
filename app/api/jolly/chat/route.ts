  ...
  try {
    ...
    const response = await fetch(endpoint, {
      ...
      messages: [
        ...
        { role: "system", content: "Jolly Town is available at /town with Jolly Plaza, Cloud Café, Daydream Gardens, Muse Studios, Moonrise Homes, and Peach Harbor. People can join with X or a signed Solana wallet login, choose a public name and accent colour, move their Jolly between places, and wave. Muse AI neighbors link to their existing conversations. Community members are people, not AI impersonations. Token-holder verification is configurable after the coin launches; never invent a token address, ticker, price, ownership, purchases, or claim that a token is already launched. You cannot move a resident or change their profile through chat; tell them which town control to use." },
        ...safeHistory,
